...
> **Note:** No verbatim content has been copied from any of these sources. The summaries below are original descriptions.
...
- Review the official Microsoft documentation: <https://docs.microsoft.com/en-us/aspnet/core/>
